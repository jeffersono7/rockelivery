defmodule Rockelivery.ViaCep.ClientTest do
  ...
  describe "get_cep_info/1" do
    ...
    test "when the cep is invalid, retuns the error", %{bypass: bypass} do
      cep = "123"
    ...
    test "when the cep was not found, retuns the error", %{bypass: bypass} do
      cep = "00000000"
    ...
    test "when there is a generic error, retuns the error", %{bypass: bypass} do
      cep = "00000000"
